...
<head>
    ...
    <title>Momas</title>
    <link rel="stylesheet" href="views/css/paginaPrincipal.css?10222023">
    ...
    <section class="home" id="home">
        <div class="content">
            ...
            <p>
                ...
                karen julian<<<<<
                niuaaaaaallerrrrr
                juan es un peo todo patico
                momas t da vida momas es amor
                momas t da vida momas es amor
            </p>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            <div class="video-container">
                <video src="views/videos/cumbion.mp4" loop autoplay muted></video>
            ...
            <div class="content">
                ...
                <a href="views/sobreNosotros.php" class="btn">leer mas</a>
            </div>
        </div>
    </section>
